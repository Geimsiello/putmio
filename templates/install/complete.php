...
<div class="text-center flex flex-col items-center py-4">
  ...
  <a href="<?= putmio_e($login) ?>" class="group w-full inline-flex items-center justify-center gap-3 install-btn-primary py-5 px-8 rounded-2xl font-body-md text-[16px] shadow-xl shadow-primary/10 transition-all duration-200 hover:shadow-[0_0_30px_rgba(128,131,255,0.35)]">
