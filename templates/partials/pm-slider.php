...
<div class="pm-slider relative" id="<?= putmio_e($sliderId) ?>" data-pm-slider>
  ...
  <div class="pm-slider__track flex gap-4 md:gap-6 overflow-x-auto -mx-1 px-1 snap-x snap-proximity overscroll-x-contain <?= putmio_e($trackClass) ?>" data-pm-slider-track>
    <?= $sliderInner ?>
  </div>
